...
public class Country {
	...
	public static readonly Country Russia = new("Russia", Color.Green);
	public static readonly Country Italy = new("Italy", Color.LightGreen);
	...
	public static readonly Country AustriaHungary = new("Austria-Hungary", Color.Orange);
	public static readonly Country Ottoman = new("Ottoman", Color.Orange);
